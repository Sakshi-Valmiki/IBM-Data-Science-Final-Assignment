...
# =============================================================================
# TASK 2.4: Creating Callbacks (Enable/Disable Year Dropdown)
# =============================================================================
@app.callback(
...
# =============================================================================
# TASK 2.5 & 2.6: Main Plotting Callback Function
# =============================================================================
@app.callback(
...
def update_output_container(Report_type, input_year):
    if Report_type == 'Recession Period Statistics':
        ...
        # Plot 1: Yearly Automobile Sales Using Line Chart over the whole period
